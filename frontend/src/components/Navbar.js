...
//import sideBarAnimation from '../oth/sideBarAnimation';
...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full flex items-center justify-between bg-secondary px-4 z-50 transition-all duration-300'>
      ...
      <div
        className={`fixed left-0 top-0 sms:w-[80vw] overflow-hidden mds:w-[80vw] h-full border-r rounded-r-2xl border-r-gray-400 bg-secondary transition-transform duration-500 ${nav ? 'translate-x-0' : '-translate-x-full'}`}
      >
        <div className='relative flex-col h-screen bg-secondary w-auto flex justify-between items-center'>
              ...
              <div className='w-[80vw] flex flex-col items-center  justify-center h-auto'>
                        ...
                        <div className='flex w-[75vw] items-center justify-center p-6 gap-8'>
                          <span className="flex items-center justify-center text-gray-400 hover:text-primary h-6 w-6 transition-transform cursor-pointer">
                                                                <svg
                  ...
                  <div className='flex flex-col bg-transparent items-center justify-center mb-8 space-y-5'>
                    <h2 className="flex flex-col text-primary font-ibmplexsans items-center text-sm" style={{fontWeight:'400'}}>Connect, share.{''}<div className=''>Be part of the story</div></h2>                    
