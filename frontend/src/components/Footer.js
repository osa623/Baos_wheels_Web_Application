  ...
  return (
    <footer className="w-full bg-secondary flex flex-col items-center">
      ...
      <div className="flex justify-center space-x-8 py-4">
                                      <Link to={'https://www.facebook.com/Baos623/'}  class="[&>svg]:h-6 [&>svg]:w-6 cursor-pointer">
                                                <svg
                                      ...
                                      <Link to={'https://www.instagram.com/baos.623/'}class="[&>svg]:h-6 [&>svg]:w-6 cursor-pointer ">
                                                <svg
                                                  xmlns="http://www.w3.org/2000/svg"
                                                  fill="currentColor"
                                                  class="text-gray-400 scale-125 hover:scale-150 transition-transform"
                                      ...
                                      <Link to={'https://www.youtube.com/@baos_623'}  class="[&>svg]:h-6 [&>svg]:w-6 cursor-pointer">
                                                <svg
                                                  xmlns="http://www.w3.org/2000/svg"
                                                  fill="currentColor"
                                                  class="text-gray-400 scale-125 hover:scale-150 transition-transform"
                                       ...
                                       <Link to={'https://www.tiktok.com/@baos_623'}  class="[&>svg]:h-6 [&>svg]:w-6 cursor-pointer">
                                                  <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    fill="currentColor"
                                                    class="text-gray-400 scale-125 hover:scale-150 transition-transform"
